      ...
      segments: [
        {
          ...
          words: [
            ...
            { word: 'TechXayan', start: 0.9, end: 1.6 },
            { word: 'Creative', start: 1.7, end: 2.3 },
            { word: 'video', start: 2.4, end: 2.7 },
            { word: 'editor.', start: 2.8, end: 3.1 },
          ],
        },
        {
          id: 'seg-2',
          ...
          words: [
            { word: 'Empowering', start: 3.3, end: 4.1 },
            { word: 'creators', start: 4.2, end: 4.8 },
            { word: 'on', start: 4.9, end: 5.1 },
            { word: 'Windows', start: 5.2, end: 5.7 },
            { word: 'and', start: 5.8, end: 5.9 },
            { word: 'Android.', start: 6.0, end: 6.4 },
          ],
        },
      ],
    };
